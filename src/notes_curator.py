...
summarize, or rewrite wording, and do not add or remove facts. Do not use
general or outside knowledge to add detail, context, or explanation beyond
what each document already contains. Return each kept document with its
title and its blocks, preserving whether each block was a heading, a
paragraph, a bullet list, a flowchart, or a table, including a flowchart's
nodes and edges or a table's headers and rows exactly as given.
""".strip()
CURATION_ATTEMPTS = 2
